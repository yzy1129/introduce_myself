      ...
      <section className="chapter-crossroads story-section">
        <div className="chapter-crossroads-shell">
          <div className="chapter-crossroads-head">
            <span>继续查看项目</span>
            <p>可以返回项目总览，也可以直接进入上一个或下一个项目详情。</p>
          </div>

          <div className="chapter-crossroads-grid">
            <AppLink
              className="chapter-crossroads-card"
            ...
            <AppLink
              className="chapter-crossroads-card chapter-crossroads-card-home"
              to="/projects"
            >
              <em>返回项目章节</em>
              <strong>{siteContent.projects.heading}</strong>
              <p>回到项目总览页，重新选择要深入查看的项目。</p>
            </AppLink>
            <AppLink
              className="chapter-crossroads-card"
