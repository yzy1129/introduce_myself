      ...
      >
        <div className="route-hero-shell">
          ...
          <div className="route-hero-visual">
            ...
            <div className="route-hero-beam" aria-hidden="true" />

            <div className="route-hero-visual-shell">
              <article
                className={`route-hero-stage-card ${stageCardExpanded ? "is-expanded" : "is-collapsed"}`}
              >
                <button
                  type="button"
                  className="route-hero-stage-toggle"
                  aria-expanded={stageCardExpanded}
                  aria-controls={`chapter-stage-card-${chapter.id}`}
                  onClick={() => setStageCardExpanded((current) => !current)}
                >
                  <span className="route-hero-stage-toggle-dot" aria-hidden="true" />
                  <span className="route-hero-stage-toggle-copy">
                    <em>{heroStage.kicker}</em>
                    <strong>{stageCardExpanded ? "收起章节说明" : chapter.title}</strong>
                    <small>
                      {stageCardExpanded
                        ? "折叠后只保留简洁导航层"
                        : "展开查看本章阐释与阅读线索"}
                  ...
                  <span className="route-hero-stage-toggle-icon" aria-hidden="true" />
                </button>

                <div
                  id={`chapter-stage-card-${chapter.id}`}
                  className="route-hero-stage-body"
                >
              ...
              <div className="route-hero-system" aria-hidden="true">
              ...
              <div className="route-hero-ribbon" aria-hidden="true">
